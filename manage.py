...
from spaffnerds.app import create_app
from spaffnerds.database import db
from spaffnerds.settings import DevConfig, ProdConfig
from spaffnerds.user.models import User
from spaffnerds.music.models import Show, Venue, Song, ShowSongLink

CONFIG = ProdConfig if os.environ.get('SPAFFNERDS_ENV') == 'prod' else DevConfig
...
def _make_context():
    ...
    return {'app': app, 'db': db, 'User': User, 'Show': Show, 'Venue': Venue, 'Song': Song, 'ShowSongLink': ShowSongLink}
